        ...
        <div className="flex h-screen bg-gray-100 dark:bg-zinc-900">
            ...
            <aside className="w-64 bg-white dark:bg-zinc-800 border-r border-gray-200 dark:border-zinc-700">
                ...
                <nav className="mt-6 px-4 space-y-2">
                    ...
                    <NavItem href="/admin/quizzes" label="Quizzes & Tests" icon="📝" />
                    <NavItem href="/admin/coupons" label="Coupons" icon="🎟️" />
                    <NavItem href="/admin/users" label="Manage Users" icon="👥" />
                    <NavItem href="/admin/leads" label="Leads / Inquiries" icon="📞" />
                    <NavItem href="/admin/analytics" label="Funnel Analytics" icon="📈" />
                    <NavItem href="/admin/prescriptions" label="Prescriptions" icon="✍️" />
